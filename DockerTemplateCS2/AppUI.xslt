...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="b3284dba-9fdf-4a15-8fe9-a65fb183af9e" noBmpOnMenu="true"
                type="checkButton"
                check="*Docker('8742437c-1f33-4f44-a48f-20db1f1eb943')"
                dynamicCategory="2cc24a3e-fe24-4708-9a74-9c75406eebcd"
                userCaption="MySampleDocker"
                enable="true"/>

      <!-- Define the web control which will be placed on our docker -->
      <itemData guid="c03e3b9a-c3d7-4f5a-9f96-976c95b14687"
                type="wpfhost"
                hostedType="Addons\DockerTemplateCS2\DockerTemplateCS2.dll,DockerTemplateCS2.DockerUI"
                enable="true"/>
  ...
  <xsl:template match="uiConfig/dockers">
    <xsl:copy>
      ...
      <dockerData guid="8742437c-1f33-4f44-a48f-20db1f1eb943"
                  userCaption="MySampleDocker"
                  wantReturn="true"
                  focusStyle="noThrow">
        <container>
          <!-- add the webpage control to the docker -->
          <item dock="fill" margin="0,0,0,0" guidRef="c03e3b9a-c3d7-4f5a-9f96-976c95b14687"/>
        </container>
      </dockerData>
    </xsl:copy>
  </xsl:template>
